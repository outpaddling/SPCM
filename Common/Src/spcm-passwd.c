...
#define SYNC_CMD    "%%PREFIX%%/sbin/spcm-sync-pw %s"
...

{
     ...
     *  Use absolute pathnames for spcm-sync-pw and restrict PATH
     *  in spcm-sync-pw and all scripts eventually run from it.
     */
